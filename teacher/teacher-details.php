                        ...
                        <div class="heading-layout1">
                           ...
                           <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="edit-teacher-details.php"><i class="fa fa-cogs text-dark-pastel-green"></i>Edit</a>
                                    <a class="dropdown-item" href="#"><i class="fa fa-redo text-orange-peel"></i>Refresh</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    ...
                                    <div class="header-elements">
                                        <ul>
                                            <li><a href="edit-teacher-details.php" title="edit"><i class="fa fa-edit"></i></a></li>
