...
?>
            <div class="dashboard-content-one">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-3-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    <div class="item-icon bg-light-magenta" style="padding-top: 11px;">
                            ...
                            <div class="col-3-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    <div class="item-icon bg-light-blue" style="padding-top: 12px;">
                                        <i class="fa fa-money-bill text-blue"></i>
                                    </div>
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="19050">19,050</span></div>
                                        <div class="item-title">Student owing</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    <div class="item-icon bg-light-yellow" style="padding-top: 12px;">
                                        <i class="fa fa-money-bill text-orange"></i>
                                    </div>
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="23890">23,890</span></div>
                                        <div class="item-title">Student not owing</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    <div class="item-icon bg-light-red" style="padding-top: 12px;">
                                        <i class="fa fa-money-bill text-red"></i>
                                    </div>
                                    <div class="item-content">
                                        <div class="item-number"><span>$</span><span class="counter" data-num="2102050">21,02,050</span></div>
                                        <div class="item-title">Total Debt</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-6-xxxl col-xl-6">
                                ...
                                <div class="heading-layout1">
                                   ...
                                   <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"><i class="fa fa-times text-orange-red"></i>Close</a>
