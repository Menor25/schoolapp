                ...
                <ul class="navbar-nav">
                    ...
                    <li class="navbar-item dropdown header-notification">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-icon bg-skyblue" style="padding-top: 3px;">
                                ...
                                <div class="media">
                                    <div class="item-icon bg-orange" style="padding-top: 1px;">
                                ...
                                <div class="media">
                                    <div class="item-icon bg-violet-blue" style="padding-top: 1px;"> 
